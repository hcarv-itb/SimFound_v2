...
box_size=11.0
print(type(replicate), replicate)
project=main.Project(title='SETD2-h3K36', 
                     hierarchy=('protein', 'ligand', 'parameter'), 
                     workdir=data_path,
                     parameter=parameters, 
                     replicas=int(replicate), 
                     protein=protein, 
                     ligand=ligand,
                     topology='SETD2_complexed_noSub.pdb',
                     timestep=timestep,
                    initial_replica=int(replicate))
...
extra_pdb = ['SETD2-h3K36_1-1_B_edit.pdb', 
             'SETD2-h3K36_1-1_C_edit.pdb', 
             'SETD2-h3K36_1-1_D.pdb'] #, 
...
simulation.pdb2omm(input_pdb='SETD2-h3K36_1-1_A.pdb',
                    ff_files=xml_files,
                    protonate=True,
                    solvate=True,
                    pH_protein=7.0,
